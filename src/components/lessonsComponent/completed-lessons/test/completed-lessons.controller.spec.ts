...
describe('CompletedLessonsController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<CompletedLessonsController>(
      CompletedLessonsController,
    );
  ...
  describe('create', () => {
    ...
    describe('when create is called', () => {
      ...
      beforeEach(async () => {
        completedLesson = (
          await controller.create(completedLessonsCreateStub())
        ).response;
      });
  ...
  describe('findByPk', () => {
    ...
    describe('when findByPk is called', () => {
      ...
      beforeEach(async () => {
        completedLesson = (await controller.findByPk(completedLessonsStub().id))
          .response;
      });
  ...
  describe('update', () => {
    ...
    describe('when update is called', () => {
      ...
      beforeEach(async () => {
        result = (await controller.update(completedLessonsUpdateStub()))
          .response;
      });
