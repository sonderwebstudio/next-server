...
describe('LessonsInCoursesController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<LessonsInCoursesController>(
      LessonsInCoursesController,
    );
  ...
  describe('create', () => {
    ...
    describe('when create is called', () => {
      ...
      beforeEach(async () => {
        lessonInCourse = (await controller.create(lessonsInCoursesCreateStub()))
          .response;
      });
  ...
  describe('findByPk', () => {
    ...
    describe('when findByPk is called', () => {
      ...
      beforeEach(async () => {
        lessonInCourse = (await controller.findByPk(lessonsInCoursesStub().id))
          .response;
      });
  ...
  describe('update', () => {
    ...
    describe('when update is called', () => {
      ...
      beforeEach(async () => {
        result = (await controller.update(lessonsInCoursesUpdateStub()))
          .response;
      });
